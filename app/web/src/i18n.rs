...
strings! {
    ...
    (attach_too_large, "That file is larger than 25 MB.", "파일이 25MB보다 큽니다.", "そのファイルは25MBを超えています。", "該檔案超過 25 MB。", "Tento soubor je větší než 25 MB.", "Ese archivo supera los 25 MB.", "该文件大于 25 MB。", "Diese Datei ist größer als 25 MB."),
