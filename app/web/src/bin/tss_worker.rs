...
//! `src/tss.rs`. Everything CPU-heavy about an MPC wallet — the DKG,
//! every signing ceremony, the PBKDF2 that opens a quorum — runs here,
//! off the main thread, inside the user's browser.
