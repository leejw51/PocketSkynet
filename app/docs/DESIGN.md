...
> **TSS wallet** (`login.rs::Method`). The TSS tab collects a server-held
> wallet choice and its passphrase instead of key material, and carries the
> m-of-n create form (shape selects, passphrase twice, DKG progress) —
